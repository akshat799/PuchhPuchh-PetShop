      ...
      <div className="nav-options">
        ...
        </div>
        {
          user ? (
            ...
            <Button component= {Link} to="/auth" variant="contained" style={{display:"flex", marginTop: "18px" ,color:"aliceblue" ,background:"transparent",border:"none",fontSize:"1rem"}}>Sign In</Button>
          )       
        }
